...
?>
    <section class="flex-grow max-w-6xl mx-auto w-full p-4 sm:p-6 bg-white">
        <h2 class="text-center text-3xl text-[#1e482a] font-bold mt-5">Términos y condiciones</h2>

        <div class="mt-8 space-y-8 text-gray-800 text-justify text-base leading-relaxed sm:px-20 px-2">
             <p class="text-sm text-gray-500 mb-8 text-end">Última actualización: 6 de julio de 2022</p>

  <!-- Introducción -->
  <div class="mb-10">
    <h2 class="text-2xl font-semibold mb-4">Relación contractual</h2>
            <p class="mb-4">
            Estas Condiciones regulan el acceso y uso de los Servicios ofrecidos por <span class="text-[#1e482a] font-bold">ZimbraTubos&reg;</span>. Al suscribirse en el sitio web, usted acepta todos los términos establecidos. Si no los acepta, no está autorizado a utilizar el sitio ni los servicios.
            </p>
            <p>
            Estos Términos constituyen un acuerdo legalmente vinculante entre usted y <span class="text-[#1e482a] font-bold">ZimbraTubos&reg;</span>. Regulan la compra, uso, y acceso al sitio web, servicios, herramientas y productos ofrecidos.
            </p>
        </div>
        ...
        <div class="mb-10">
            ...
            <li>Aceptar los términos y proporcionar información veraz y actualizada.</li>
            <li>No residir en territorios sancionados por el gobierno de México.</li>
            <li>No estar en listas de personas restringidas.</li>
            </ul>
            <p class="mt-4">
            El acceso por menores de edad implica el consentimiento explícito de sus padres o tutores.
            </p>
        </div>
        ...
        <div class="mb-10">
            ...
            <p class="mb-4">
            Al adquirir una licencia de software, se otorga una licencia limitada y revocable. Usted no adquiere propiedad sobre el software.
            </p>
            <p class="font-semibold mt-4 mb-2">Actividades prohibidas:</p>
            <ul class="list-disc ml-6 space-y-2">
            <li>Actos ilegales, hackeo o recolección de datos sin permiso.</li>
            <li>Spamming o envío de comunicaciones no solicitadas.</li>
            <li>Uso de lenguaje ofensivo o engañoso.</li>
            <li>Ingreso de información confidencial como datos bancarios o de salud.</li>
            </ul>
        </div>
        ...
        <div class="mb-10">
            ...
            <li>Es responsable de mantener segura su contraseña.</li>
            <li>Debe notificar cualquier uso no autorizado.</li>
            </ul>
        </div>
