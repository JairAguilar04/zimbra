...
?>
    ...
    <section class="flex-grow max-w-6xl mx-auto w-full p-4 sm:p-6 bg-white">
        <h2 class="text-center text-3xl text-[#1e482a] font-bold mt-10">Construye con facilidad y precisión</h2>
        
            <div class="flex flex-rows items-center gap-x-5 px-20 mt-5">
                <div class="flex-1">
        ...
        <div class="mt-16">
            <div class="text-center px-20 ">
                <h2 class="text-3xl font-bold text-[#1e482a]">
    ...
    <!-- cards -->
    <section class="max-w-6xl mx-auto w-full p-4 sm:p-14 bg-gray-100 flex items-center">
        <div class="flex items-center w-80 h-32 p-4 transform duration-300 hover:-translate-y-1">
            ...
            <div class="">
                <h3 class="text-[#2f767c] text-xl font-bold ">ZimbraTubos&reg; tú mejor elección</h3>
        ...
        <div class="flex items-center w-80 h-32 p-4 transform duration-300 hover:-translate-y-1">
            ...
            <div class="">
                <h3 class="text-[#2f767c] text-xl font-bold ">Material de alta calidad</h3>
        ...
        <div class="flex items-center w-80 h-32 p-4 transform duration-300 hover:-translate-y-1">
            ...
            <div class="">
                <h3 class="text-[#2f767c] text-xl font-bold ">Envío a todo el país</h3>
        ...
        <div class="flex items-center w-80 h-32 p-4 transform duration-300 hover:-translate-y-1">
            ...
            <div class="">
                <h3 class="text-[#2f767c] text-xl font-bold ">Comprometidos con el reciclaje</h3>
